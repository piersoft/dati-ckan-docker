...
wget "https://raw.githubusercontent.com/italia/daf-ontologie-vocabolari-controllati/master/VocabolariControllati/territorial-classification/territorial-classification.rdf" -O "/tmp/Istat-Classificazione-08-Territorio.rdf"
